...
LANE_RANK = {"twin-inventory": 100, "zz-runtime-overlay": 200, "m6-journeys": 150, "zz-worker-gaps": 120,
             "m7-ingress": 170, "zz-s2p-namespace": 90, "m11-trust-path": 190}   # M11: promoted real services outrank the inventory's substitute view   # M7: ingress lane upgrades the api-monolith routes it serves; S2P namespace never overrides
